...
final mockData = [
  ...
  {"id": 78, "name": "Complement C4", "description": "مناعة", "category_id": 8},
  {"id": 79, "name": "Anti-CCP", "description": "روماتويد", "category_id": 8},
  {"id": 80, "name": "ESR", "description": "التهابات", "category_id": 8},
  {
    "id": 5,
  ...
  {"id": 7, "name": "MCV", "description": "حجم كريات الدم", "category_id": 1},
  {
    "id": 8,
    "name": "MCH",
  ...
  {"id": 10, "name": "RDW", "description": "توزع كريات الدم", "category_id": 1},
  ...
  {"id": 18, "name": "اليوريا", "description": "تقييم الكلى", "category_id": 2},
  {"id": 19, "name": "ALT", "description": "إنزيمات الكبد", "category_id": 2},
  {"id": 20, "name": "AST", "description": "وظائف الكبد", "category_id": 2},

  // ================= الهرمونات =================
  {"id": 21, "name": "TSH", "description": "الغدة الدرقية", "category_id": 3},
  {
    "id": 22,
    "name": "T3",
  ...
  {"id": 24, "name": "FSH", "description": "هرمون الخصوبة", "category_id": 3},
  {"id": 25, "name": "LH", "description": "هرمون التبويض", "category_id": 3},
  {
    "id": 26,
    "name": "البرولاكتين",
  ...
  {"id": 43, "name": "HCV", "description": "التهاب الكبد C", "category_id": 5},
  {
    "id": 44,
    "name": "COVID-19",
  ...
  {"id": 45, "name": "CRP", "description": "الالتهابات", "category_id": 5},
  {"id": 46, "name": "ESR", "description": "سرعة الترسيب", "category_id": 5},
  {"id": 47, "name": "D-dimer", "description": "التجلطات", "category_id": 5},
  {
    "id": 48,
    "name": "Ferritin",
  ...
  {"id": 49, "name": "IgG", "description": "مناعة طويلة", "category_id": 5},
  {"id": 50, "name": "IgM", "description": "مناعة حديثة", "category_id": 5},
  ...
  {"id": 54, "name": "كريات الدم", "description": "نزيف", "category_id": 6},
  {
    "id": 55,
    "name": "الكيتونات",
  ...
  {"id": 59, "name": "Leukocytes", "description": "التهاب", "category_id": 6},
  {
    "id": 60,
    "name": "Bilirubin",
  ...
  {"id": 63, "name": "دم مخفي", "description": "نزيف داخلي", "category_id": 7},
  {
    "id": 64,
    "name": "زرع البراز",
  ...
  {"id": 66, "name": "PH البراز", "description": "حموضة", "category_id": 7},
  {"id": 67, "name": "WBC بالبراز", "description": "التهاب", "category_id": 7},
  {"id": 68, "name": "Mucus", "description": "مخاط", "category_id": 7},
  {"id": 69, "name": "Rotavirus", "description": "فيروس", "category_id": 7},
  {"id": 70, "name": "Occult blood", "description": "دم خفي", "category_id": 7},

  // ================= المناعة =================
  {"id": 71, "name": "IgA", "description": "مناعة مخاطية", "category_id": 8},
  {"id": 72, "name": "IgE", "description": "حساسية", "category_id": 8},
  {"id": 73, "name": "ANA", "description": "مناعة ذاتية", "category_id": 8},
  {
    "id": 74,
    "name": "Anti-DNA",
  ...
  {"id": 75, "name": "RF", "description": "الروماتويد", "category_id": 8},
  {"id": 76, "name": "CRP", "description": "التهابات", "category_id": 8},
  {"id": 77, "name": "Complement C3", "description": "مناعة", "category_id": 8},
];
